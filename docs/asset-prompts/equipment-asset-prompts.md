# Equipment Asset Prompts

Registered player and companion equipment icons for the vertical slices.
...
- Category: player or companion equipment icon
- Output: exact `64x64` PNG with optional transparency with at least 6px padding
- Must remain readable at `32x32`.
- Show plausible construction: joinery, bindings, edge wear, repairs, regional fibers, metal, shell, wood, hide, or Nilalang-derived material according to the recipe and slot.
- Communicate affinity through material behavior rather than neon symbols.
- Do not show a character wearing it. No scenery, inventory slot, rarity frame, text, or random gore.
...
```text
Detailed semi-realistic 2D dark Filipino folklore-horror RPG equipment icon, transparency optional with a flat removable background accepted, no text, no logo. Create a polished 64x64 icon for Woven Vest armor. Light protective vest made of woven fibers and forest cloth, warm tan with green trim, clear armor silhouette, readable at 32x32.
```
...
```text
Detailed semi-realistic 2D dark Filipino folklore-horror RPG equipment icon, transparency optional with a flat removable background accepted, no text, no logo. Create a polished 64x64 icon for River Charm. Small charm with river stone, blue cord, bamboo or shell detail, gentle movement motif, player accessory, readable at 32x32.
```
...
```text
Detailed semi-realistic 2D dark Filipino folklore-horror RPG companion equipment icon, transparency optional with a flat removable background accepted, no text, no logo. Create a polished 64x64 icon for Leaf-Thread Charm. Tiny woven green charm for a bonded Nilalang companion, leaf fibers, soft firefly glow, gentle forest blessing, readable at 32x32.
```
...
```text
Detailed semi-realistic 2D dark Filipino folklore-horror RPG companion equipment icon, transparency optional with a flat removable background accepted, no text, no logo. Create a polished 64x64 icon for Balete Keepsake. Small keepsake made from cleared shrine remnants, old root bead, muted gold tie, dark bark accent, protective companion gear, readable at 32x32, not ominous.
```
